...
rm -rf $DD; mkdir -p $DD
"$B/bitcoind" -regtest -datadir=$DD -daemon -mortalgenesis="Call me Ishmael. Some years ago, having little money, I went to sea." -fallbackfee=0.0001
...
echo "--- no successor magazine configured (-mortalnextnovel); mining past the end starves ---"
